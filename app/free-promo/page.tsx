          ...
          <div className="grid grid-cols-2 gap-6 text-[#4D4D4D]">
            ...
            <div className="relative flex min-h-[520px] flex-col bg-sky-50 p-6 lg:p-10">
              ...
              <a
                ...
                className="mt-auto inline-flex w-fit rounded-full bg-[#142674] px-10 py-4 text-lg font-semibold text-white hover:bg-mainColor4 transition"
              >
            ...
            <div className="relative flex min-h-[520px] flex-col rounded-2xl text-[#4D4D4D] p-6 lg:p-10">
              <div className="flex flex-col gap-6">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-6 inline-flex w-fit rounded-full bg-[#142674] px-12 py-4 text-lg font-semibold text-white hover:bg-mainColor4 transition"
                >
                  Download Logo
                </a>
              </div>
