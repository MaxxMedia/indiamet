          ...
          <div className="max-w-10xl mx-auto">
              ...
              <div className="space-y-8">
                <div className="border-b pb-6">
                  <h2 className="text-2xl font-bold text-[#C8102E] mb-3">1. Notice</h2>
                ...
                <div className="border-b pb-6">
                  <h2 className="text-2xl font-bold text-[#C8102E] mb-3">2. What Are Cookies?</h2>
                  <p className="text-gray-700">
                ...
                <div className="border-b pb-6">
                  <h2 className="text-2xl font-bold text-[#C8102E] mb-3">3. Purpose of Using Cookies</h2>
                ...
                <div className="border-b pb-6">
                  <h2 className="text-2xl font-bold text-[#C8102E] mb-3">4. Types of Cookies Used</h2>
                  <div className="space-y-3 text-gray-700">
                ...
                <div className="border-b pb-6">
                  <h2 className="text-2xl font-bold text-[#C8102E] mb-3">5. Cookie Management and Control</h2>
                ...
                <div className="border-b pb-6">
                  <h2 className="text-2xl font-bold text-[#C8102E] mb-3">6. Updates to This Policy</h2>
                  <p className="text-gray-700">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-[#C8102E] mb-3">7. Contact Information</h2>
              ...
              <div className="mt-10 p-6 bg-blue-50 rounded-lg border border-blue-200">
                <h3 className="text-xl font-semibold text-[#C8102E] mb-4">How to Manage Cookies in Different Browsers</h3>
