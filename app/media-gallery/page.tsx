            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {mediaItems.map((item) => (
                <Link
                  key={item.id}
                  href={item.href}
                  className="group relative flex flex-col rounded-xl overflow-hidden bg-[#2c3531] shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-1"
                >
                  {/* Image Container */}
