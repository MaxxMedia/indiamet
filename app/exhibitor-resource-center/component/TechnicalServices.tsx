            ...
            <div className="relative z-[1] flex size-full min-h-[500px] flex-col bg-amber-50 p-5 lg:p-10">
              <div className="z-[1] flex flex-col gap-5">
                ...
                <div className="flex w-full flex-wrap gap-5">
                  ...
                  >
                    <button className="flex-center group w-fit gap-2 overflow-hidden rounded-full px-10 py-3 font-jakarta text-[16px] font-semibold global-transition bg-[#028C00] text-white hover:bg-mainColor4">
