            ...
            <div key={index} className="grid grid-cols-1 lg:grid-cols-12 items-center gap-8 p-6 bg-white rounded-xl shadow-sm">
              ...
              <div className="lg:col-span-3 flex justify-center lg:justify-end">
                <Link href={option.link}>
                  <button className="inline-flex items-center justify-center gap-2 rounded-full bg-[#2E9CCA] p-4 text-white transition-all duration-300 hover:bg-mainColor4">
                    <svg
                      stroke="white"
                      fill="white"
                      strokeWidth="0"
