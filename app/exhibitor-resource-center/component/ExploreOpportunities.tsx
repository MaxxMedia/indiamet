    ...
    <section className="py-16">
      <SectionContainer>
        <div className="flex flex-col gap-8">
          ...
          >
            <button className="flex items-center justify-center gap-2 overflow-hidden rounded-full bg-[#FE6B0B] px-10 py-3 font-jakarta text-[16px] font-semibold text-white transition-all duration-300 hover:bg-mainColor4">
              Download Guide
            </button>
          </Link>
        </div>
