                    ...
                    <SectionContainer>
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className="relative h-80 lg:h-96 rounded-lg overflow-hidden bg-gradient-to-br from-[#00857C]/20 to-[#191C1C]/20 border-2 border-[#00857C]/20 transition-all duration-300 flex items-center justify-center"
                            >
                    ...
                    <SectionContainer>
                        ...
                        >
                            {jury.map((member) => (
                                ...
                                >
                                    <div className="h-48 bg-gradient-to-br from-[#00857C]/10 to-[#191C1C]/10 flex items-center justify-center">
                        ...
                        <div className="relative overflow-hidden">
                            ...
                            >
                                {[...sponsors, ...sponsors].map((sponsor, index) => (
                                    ...
                                    >
                                        <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#00857C]/10 to-[#191C1C]/10 flex items-center justify-center">
                        ...
                        <div className="relative overflow-hidden">
                            ...
                            >
                                ...
                                {[...supporters, ...supporters].map((supporter, index) => (
                                    ...
                                    >
                                        {/* Icon */}
                                        <div className="w-20 h-20 bg-gradient-to-br from-[#00857C]/10 to-[#191C1C]/10 rounded-full flex items-center justify-center">
