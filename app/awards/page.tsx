                        ...
                        <SectionContainer>
                            <div className="max-w-4xl text-white">
                                <motion.div
                                    ...
                                    transition={{ duration: 0.6 }}
                                >
                                    <span className="inline-block text-[15px] tracking-widest text-[#142674] border border-[#142674]/40 rounded-full px-3 py-1 mb-4">
                                ...
                                >
                                    GLOBAL METROLOGY
                                    <br />
                                    <span className="text-[#142674]">EXCELLENCE AWARDS (GMEA)</span>
                                </motion.h1>
                                ...
                                >
                                    <Link
                                        href="/Sponsor"
                                        className="border border-[#142674]/60 text-[#142674] hover:bg-[#142674]/10 font-semibold px-6 py-3 rounded-full text-sm transition-colors text-center"
                                    >
                                        SPONSOR NOW
                                    </Link>
                                    <Link
                                        href="/Nominate"
                                        className="bg-[#142674] hover:bg-[#142674]/90 text-white font-semibold px-6 py-3 rounded-full text-sm transition-colors text-center"
                                    >
                                        NOMINATE NOW ↗
                                    </Link>
                                </motion.div>
                    ...
                    <SectionContainer>
                        ...
                        >
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-xl">
                                    {stats.map(([n, l]) => (
                                        <motion.div
                                            ...
                                            className="border-l-2 border-[#142674] pl-4"
                                        >
                                            <p className="text-[#142674] font-bold text-2xl">{n}</p>
                            ...
                            <motion.div
                                ...
                                className="relative h-80 lg:h-96 rounded-lg overflow-hidden bg-gradient-to-br from-[#142674]/20 to-[#142674d]/20 border-2 border-[#142674]/20 transition-all duration-300 flex items-center justify-center"
                            >
                    ...
                    <SectionContainer>
                        ...
                        >
                            {whyParticipate.map(([icon, title, desc]) => (
                                ...
                                >
                                    <span className="text-3xl text-[#142674] block mb-3">{icon}</span>
                        ...
                        >
                            {categories.map(([icon, title]) => (
                                <motion.div
                                    ...
                                    className="min-h-[150px] border border-gray-200 rounded-xl p-6 flex flex-col items-center justify-center text-center gap-4 bg-white hover:border-[#142674] transition-all duration-300"
                                >
                                ...
                                >
                                    <div className="flex flex-col items-center text-center gap-4 flex-1">
                                        ...
                                        <motion.div
                                            ...
                                            transition={{ duration: 0.2 }}
                                            className="w-24 h-24 md:w-28 md:h-28 rounded-full border-3 border-[#142674] flex items-center justify-center text-4xl md:text-5xl bg-white shadow-md"
                                        >
                                            {icon}
                                        </motion.div>

                                        {/* PROCESS TITLE */}
                                        <p className="text-[#142674] text-sm md:text-base font-bold tracking-wide leading-snug">
                                            {title}
                                        </p>
                                    ...
                                    {/* ARROW */}
                                    {i < process.length - 1 && (
                                        <span className="hidden md:flex items-center justify-center text-[#142674] text-3xl font-bold mx-2 h-28">
                                            →
                                        </span>
                                    )}
                                </motion.div>
                    ...
                    <SectionContainer>
                        ...
                        >
                            {jury.map((member) => (
                                ...
                                >
                                    <div className="h-48 bg-gradient-to-br from-[#142674]/10 to-[#142674d]/10 flex items-center justify-center">
                                        <span className="text-6xl">👤</span>
                                    </div>
                                    <div className="p-4">
                                        <span className="inline-block text-[10px] tracking-wide text-[#142674] border border-[#142674]/40 rounded px-2 py-0.5 mb-2">
                        ...
                        >
                            ...
                            <Link
                                href="/jury"
                                className="inline-block border border-[#142674] text-[#142674] hover:bg-[#142674]/10 px-6 py-2 rounded-full text-sm font-medium transition-colors"
                            >
                                VIEW ALL JURY
                            </Link>
                        </motion.div>
                            ...
                            >
                                {[...sponsors, ...sponsors].map((sponsor, index) => (
                                    <motion.div
                                        ...
                                        className="flex-shrink-0 w-[220px] md:w-[260px] min-h-[180px] bg-white border border-gray-200 rounded-xl p-6 flex flex-col items-center justify-center gap-4 hover:border-[#142674] transition-all duration-300"
                                    >
                                        <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#142674]/10 to-[#142674d]/10 flex items-center justify-center">
                                            <span className="text-2xl font-bold text-[#142674]">
                                        ...
                                        <div className="text-center">
                                            ...
                                            <p className="text-[#142674] text-sm font-semibold mt-1 uppercase tracking-wide">
                                                {sponsor.role}
                                            </p>
                                        </div>
                                    </motion.div>
                            ...
                            >
                                ...
                                {[...supporters, ...supporters].map((supporter, index) => (
                                    <motion.div
                                        ...
                                        whileHover={{ y: -6 }}
                                        className="flex-shrink-0 w-[210px] md:w-[240px] min-h-[180px] flex flex-col items-center justify-center gap-3 bg-white p-6 rounded-xl border border-gray-200 hover:border-[#142674] transition-all duration-300"
                                    >
                                        {/* Icon */}
                                        <div className="w-20 h-20 bg-gradient-to-br from-[#142674]/10 to-[#142674d]/10 rounded-full flex items-center justify-center">
                                            <span className="text-3xl font-bold text-[#142674]">
