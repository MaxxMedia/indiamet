              ...
              <div className="max-w-7xl text-white">
                ...
                <div className="flex flex-wrap gap-4 mt-6 text-white/90 text-sm sm:text-base">
                  <span className="flex items-center gap-2">
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" className="size-5 shrink-0 fill-[#00857C]" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link href="/exhibiting-enquiry">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="mt-8 bg-[#00857C] hover:bg-blue-700 px-8 py-3 rounded-full font-medium"
                  >
                    Enquire to Exhibit
                  </motion.button>
                </Link>
              ...
              <div>
                ...
                <Link href="/exhibiting-enquiry">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="font-parabolica bg-[#00857C] hover:bg-blue-700 text-white px-8 py-3 rounded-full font-medium transition-all duration-300"
                  >
                    Enquire to Exhibit
                  </motion.button>
                </Link>
          ...
          <SectionContainer>
            ...
            <Link href='/exhibiting-enquiry'>
              <motion.button
                whileHover={{ scale: 1.05, boxShadow: "0 10px 25px rgba(37, 99, 235, 0.3)" }}
                whileTap={{ scale: 0.95 }}
                className="mt-8 bg-[#00857C] hover:bg-blue-700 text-white px-8 py-3 rounded-full font-medium transition-all duration-300"
              >
                Enquire to Exhibit
              </motion.button>
            </Link>
            ...
            >
              ...
              <Link href="/sectors">
                <motion.button
                  whileHover={{ scale: 1.05, boxShadow: "0 10px 25px rgba(37, 99, 235, 0.3)" }}
                  whileTap={{ scale: 0.95 }}
                  className="mt-16 lg:mt-24 bg-[#00857C] hover:bg-blue-700 text-white px-6 py-3 rounded-full font-medium transition-all duration-300"
                >
...
From quality heads, metrology engineers, plant managers, manufacturing leaders, R&D professionals, procurement specialists, OEMs, calibration laboratories, and testing organizations to precision engineering companies, visitors attend INDIAMET 2027 to discover the latest technologies, evaluate innovative solutions, connect with global suppliers, and build strategic business partnerships.              </motion.p>
              ...
              <Link href="/post-show-report">
                {/* <motion.button
                  whileHover={{ scale: 1.05, boxShadow: "0 10px 25px rgba(37, 99, 235, 0.3)" }}
                  whileTap={{ scale: 0.95 }}
                  className="bg-[#00857C] hover:bg-blue-800 text-white px-10 py-4 rounded-full text-lg font-medium transition-all duration-300"
                >
                  Know More Insights
                </motion.button> */}
              </Link>
...
},
{
  ...
  label: "Calibration Laboratories, Testing Centers, Machine Vision, CMM, NDT, Automation & Metrology Solution Providers"
                  ...
                  >
                    <div className="text-6xl font-bold text-[#00857C] mb-4 hover:text-blue-800 transition-colors duration-300">
                      {stat.value}
                    </div>
          ...
          <SectionContainer>
            ...
            >
              <Link
                ...
                className="inline-block bg-[#00857C] hover:bg-blue-700 text-white px-6 py-3 rounded-full text-base font-medium"
              >
                View Exhibitor List
              </Link>
            </motion.button>
                ...
                >
                  ...
                  <Link href={card.href}>
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="w-full bg-[#00857C] hover:bg-blue-700 text-white py-3 rounded-full font-medium transition-all duration-300"
                    >
                      {card.buttonText}
                    </motion.button>
                  </Link>
