            ...
            <SectionContainer>
              ...
              <Link href='/contact-us'>
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-[#028C00] hover:bg-blue-800 text-white px-6 sm:px-8 md:px-10 py-2 sm:py-3 md:py-4 rounded-full text-sm sm:text-base md:text-lg font-medium transition-all duration-300 w-full sm:w-auto"
                >
                  Contact Us
                </motion.button>
              </Link>
            ...
            <SectionContainer>
              ...
              >
                {[
                  ...
                  >
                    <div className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#028C00] mb-2 sm:mb-4 hover:text-blue-800 transition-colors duration-300">
                      {stat.value}
                    </div>
              ...
              >
                ...
                <Link href="/exhibition-directory">
                 <motion.button
                  whileHover={{ scale: 1.05, boxShadow: "0 10px 25px rgba(37, 99, 235, 0.3)" }}
                  whileTap={{ scale: 0.95 }}
                  className="bg-[#028C00] hover:bg-blue-800 text-white px-6 sm:px-8 py-2 sm:py-3 rounded-full text-sm sm:text-base font-medium transition-all duration-300 mb-6 sm:mb-0 w-full sm:w-auto"
                >
    ...
    <div className="text-center sm:text-left">
      <Link href="/exhibition-directory">
        <motion.button
          whileHover={{ scale: 1.05, boxShadow: "0 10px 25px rgba(37, 99, 235, 0.3)" }}
          whileTap={{ scale: 0.95 }}
          className="bg-[#028C00] hover:bg-blue-700 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full text-sm sm:text-base font-medium transition-all duration-300 w-full sm:w-auto"
        >
          View Exhibitor List
        </motion.button>
      </Link>
              ...
              <div className="text-center">
                <Link href='/sectors'>
                  <motion.button
                    whileHover={{ scale: 1.05, boxShadow: "0 10px 25px rgba(37, 99, 235, 0.3)" }}
                    whileTap={{ scale: 0.95 }}
                    className="bg-[#028C00] hover:bg-blue-800 text-white px-6 sm:px-8 py-2 sm:py-3 rounded-full text-sm sm:text-base font-medium transition-all duration-300 w-full sm:w-auto"
                  >
              ...
              >
                ...
                <div className="flex gap-3 self-start sm:self-center">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-[#028C00] text-white flex items-center justify-center transition-all duration-300"
                  >
                    →
                  </motion.button>
                </div>
  ...
  return (
    <motion.div key={index} variants={scaleIn}>
      ...
      >
        ...
        >
          <div className="bg-[#002A34] text-white p-4 sm:p-6 lg:p-8">
            <h3 className="text-lg sm:text-xl lg:text-2xl font-bold mb-2 sm:mb-3 hover:text-blue-300 transition-colors duration-300">
              {card.title}
            </h3>
            <p className="text-white/90 text-xs sm:text-sm lg:text-base leading-relaxed line-clamp-3 sm:line-clamp-4">
    ...
    href: "/visitor-registration"
                  ...
                  >
                    <div className="flex items-center justify-between mb-4 sm:mb-6">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-[#028C00] rounded-full flex items-center justify-center">
                    ...
                    <Link href={card.href}>
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="w-full bg-[#028C00] hover:bg-blue-700 text-white py-2 sm:py-3 rounded-full font-medium transition-all duration-300 text-sm sm:text-base"
                      >
                        {card.buttonText}
                      </motion.button>
                    </Link>
