...
import PartnersSection from "@/components/section/PartnersSection";
  ...
  const countries = [
    ...
    { name: 'Austria', flag: '/images/austria.webp' },
    { name: 'Sweden', flag: '/images/sweden.webp' },
    { name: 'Netherlands', flag: '/images/netherlands.png' },
    { name: 'South Korea', flag: '/images/south-korea.png' },
    { name: 'Italy', flag: '/images/italy.webp' },
    { name: 'United Kingdom', flag: '/images/uk.webp' },
    { name: 'Switzerland', flag: '/images/switzerland.webp' },
      ...
      <main className="bg-white overflow-hidden font-parabolica">
        ...
        <section className="relative min-h-[60vh] lg:min-h-[70vh] flex items-end">
          <motion.div
            ...
            style={{ backgroundImage: "url(/images/visitor.jpg)" }}
          />
...
<motion.p
  ...
  "
>
  Explore the latest metrology, measurement, inspection, calibration, testing, and precision
  engineering technologies shaping India’s smart manufacturing future.
</motion.p>
              ...
              >
                <div className="flex items-center gap-2">
                  <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" className="size-5 shrink-0 fill-[#00857C]" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M256 48C141.1 48 48 141.1 48 256s93.1 208 208 208 208-93.1 208-208S370.9 48 256 48zm106.5 150.5L228.8 332.8h-.1c-1.7 1.7-6.3 5.5-11.6 5.5-3.8 0-8.1-2.1-11.7-5.7l-56-56c-1.6-1.6-1.6-4.1 0-5.7l17.8-17.8c.8-.8 1.8-1.2 2.8-1.2 1 0 2 .4 2.8 1.2l44.4 44.4 122-122.9c.8-.8 1.8-1.2 2.8-1.2 1.1 0 2.1.4 2.8 1.2l17.5 18.1c1.8 1.7 1.8 4.2.2 5.8z"></path></svg>
            ...
            <SectionContainer>
              ...
              <Link href='/contact-us'>
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-[#00857C] hover:bg-blue-800 text-white px-6 sm:px-8 md:px-10 py-2 sm:py-3 md:py-4 rounded-full text-sm sm:text-base md:text-lg font-medium transition-all duration-300 w-full sm:w-auto"
                >
                  Contact Us
                </motion.button>
              </Link>
            ...
            <SectionContainer>
              ...
              >
                {[
                  ...
                  >
                    <div className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#00857C] mb-2 sm:mb-4 hover:text-blue-800 transition-colors duration-300">
                      {stat.value}
                    </div>
              ...
              >
                ...
                <Link href="/exhibition-directory">
                 <motion.button
                  whileHover={{ scale: 1.05, boxShadow: "0 10px 25px rgba(37, 99, 235, 0.3)" }}
                  whileTap={{ scale: 0.95 }}
                  className="bg-[#00857C] hover:bg-blue-800 text-white px-6 sm:px-8 py-2 sm:py-3 rounded-full text-sm sm:text-base font-medium transition-all duration-300 mb-6 sm:mb-0 w-full sm:w-auto"
                >
  ...
  <SectionContainer>
    ...
    >
      <div className="relative w-full h-[900px] sm:h-[750px] md:h-[900px] lg:h-[950px] rounded-lg overflow-hidden shadow-lg">
        <Image
          src="/images/segments2.png" // Replace with your image path
    ...
    <div className="text-center sm:text-left">
      <Link href="/exhibition-directory">
        <motion.button
          whileHover={{ scale: 1.05, boxShadow: "0 10px 25px rgba(37, 99, 235, 0.3)" }}
          whileTap={{ scale: 0.95 }}
          className="bg-[#00857C] hover:bg-blue-700 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full text-sm sm:text-base font-medium transition-all duration-300 w-full sm:w-auto"
        >
          View Exhibitor List
        </motion.button>
      </Link>
              ...
              <div className="text-center">
                <Link href='/sectors'>
                  <motion.button
                    whileHover={{ scale: 1.05, boxShadow: "0 10px 25px rgba(37, 99, 235, 0.3)" }}
                    whileTap={{ scale: 0.95 }}
                    className="bg-[#00857C] hover:bg-blue-800 text-white px-6 sm:px-8 py-2 sm:py-3 rounded-full text-sm sm:text-base font-medium transition-all duration-300 w-full sm:w-auto"
                  >
              ...
              >
                ...
                <div className="flex gap-3 self-start sm:self-center">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-[#00857C] text-white flex items-center justify-center transition-all duration-300"
                  >
                    →
                  </motion.button>
                </div>
  ...
  return (
    <motion.div key={index} variants={scaleIn}>
      ...
      >
        ...
        >
          <div className="bg-[#002926] text-white p-4 sm:p-6 lg:p-8">
            <h3 className="text-lg sm:text-xl lg:text-2xl font-bold mb-2 sm:mb-3 hover:text-blue-300 transition-colors duration-300">
              {card.title}
            </h3>
            <p className="text-white/90 text-xs sm:text-sm lg:text-base leading-relaxed line-clamp-3 sm:line-clamp-4">
    ...
    href: "/visitor-registration"
                  ...
                  >
                    <div className="flex items-center justify-between mb-4 sm:mb-6">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-[#00857C] rounded-full flex items-center justify-center">
                    ...
                    <Link href={card.href}>
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="w-full bg-[#00857C] hover:bg-blue-700 text-white py-2 sm:py-3 rounded-full font-medium transition-all duration-300 text-sm sm:text-base"
                      >
                        {card.buttonText}
                      </motion.button>
                    </Link>
