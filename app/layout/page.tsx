    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center">
        <div className="text-center">
          <Loader2 className="w-16 h-16 text-[#2E9CCA] animate-spin mx-auto mb-4" />
        ...
        >
          <div className="text-center">
            ...
            <motion.button
              ...
              className="bg-[#2E9CCA] text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors shadow-md"
            >
              Try Again
            </motion.button>
          </div>
    ...
    <>
      ...
      <SectionContainer>
        ...
        >
          ...
          <div className="bg-[#25274d] text-white p-6">
        ...
        >
          <h3 className="text-2xl font-semibold text-[#25274d] mb-4">About This Layout</h3>
          <div className="space-y-4 text-gray-700 leading-relaxed">
            ...
            <p>
              <strong className="text-[#2E9CCA]">Pleae Note:</strong>
            </p>
        ...
        >
          <div className="flex items-start gap-4">
            <div className="bg-blue-100 p-3 rounded-full">
              <svg className="w-6 h-6 text-[#2E9CCA]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <p className="text-gray-600">
                ...
                please contact our exhibition support team at <a href="mailto:info@diemex.in" className="text-[#2E9CCA] hover:underline">info@diemex.in</a>
              </p>
            </div>
          </div>
        </motion.div>
