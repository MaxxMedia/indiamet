    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center">
        <div className="text-center">
          <Loader2 className="w-16 h-16 text-[#C8102E] animate-spin mx-auto mb-4" />
        ...
        >
          <div className="text-center">
            ...
            <motion.button
              ...
              className="bg-[#C8102E] text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors shadow-md"
            >
              Try Again
            </motion.button>
          </div>
    ...
    <>
      ...
      <SectionContainer>
        ...
        >
          ...
          <div className="bg-[#171A1B] text-white p-6">
        ...
        >
          <h3 className="text-2xl font-semibold text-[#171A1B] mb-4">About This Layout</h3>
          <div className="space-y-4 text-gray-700 leading-relaxed">
            ...
            <p>
              <strong className="text-[#C8102E]">Pleae Note:</strong>
            </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                ...
                please contact our exhibition support team at <a href="mailto:info@INDIAMET.in" className="text-[#C8102E] hover:underline">info@INDIAMET.in</a>
              </p>
            </div>
          </div>
        </motion.div>
