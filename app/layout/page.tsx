    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center">
        <div className="text-center">
          <Loader2 className="w-16 h-16 text-[#AC3B61] animate-spin mx-auto mb-4" />
        ...
        >
          <div className="text-center">
            ...
            <motion.button
              ...
              className="bg-[#AC3B61] text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors shadow-md"
            >
              Try Again
            </motion.button>
          </div>
    ...
    <>
      ...
      <SectionContainer>
        ...
        >
          ...
          <div className="bg-[#123C69] text-white p-6">
        ...
        >
          <h3 className="text-2xl font-semibold text-[#123C69] mb-4">About This Layout</h3>
          <div className="space-y-4 text-gray-700 leading-relaxed">
            ...
            <p>
              <strong className="text-[#AC3B61]">Pleae Note:</strong>
            </p>
        ...
        >
          <div className="flex items-start gap-4">
            <div className="bg-blue-100 p-3 rounded-full">
              <svg className="w-6 h-6 text-[#AC3B61]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <p className="text-gray-600">
                ...
                please contact our exhibition support team at <a href="mailto:info@diemex.in" className="text-[#AC3B61] hover:underline">info@diemex.in</a>
              </p>
            </div>
          </div>
        </motion.div>
