          ...
          <div className="max-w-10xl mx-auto">
              ...
              <div className="space-y-8">
                <div className="border-b pb-6">
                  <h2 className="text-2xl font-bold text-[#ED5A27] mb-3">Acceptance of Terms</h2>
                ...
                <div className="border-b pb-6">
                  <h2 className="text-2xl font-bold text-[#ED5A27] mb-3">Modification of Terms</h2>
                  <p className="text-gray-700">
                ...
                <div className="border-b pb-6">
                  <h2 className="text-2xl font-bold text-[#ED5A27] mb-3">Links to Third-Party Websites</h2>
                  <p className="text-gray-700">
                ...
                <div className="border-b pb-6">
                  <h2 className="text-2xl font-bold text-[#ED5A27] mb-3">Prohibited and Unlawful Use</h2>
                  <p className="text-gray-700">
                ...
                <div className="border-b pb-6">
                  <h2 className="text-2xl font-bold text-[#ED5A27] mb-3">Materials Submitted to INDIAMET</h2>
                ...
                <div className="border-b pb-6">
                  <h2 className="text-2xl font-bold text-[#ED5A27] mb-3">Disclaimer of Liability</h2>
                  <div className="space-y-3 text-gray-700">
                ...
                <div className="border-b pb-6">
                  <h2 className="text-2xl font-bold text-[#ED5A27] mb-3">Professional Advice</h2>
                  <p className="text-gray-700">
                ...
                <div className="border-b pb-6">
                  <h2 className="text-2xl font-bold text-[#ED5A27] mb-3">Termination of Access</h2>
                  <p className="text-gray-700">
                ...
                <div className="border-b pb-6">
                  <h2 className="text-2xl font-bold text-[#ED5A27] mb-3">Governing Law and Jurisdiction</h2>
                  <p className="text-gray-700">
                ...
                <div className="border-b pb-6">
                  <h2 className="text-2xl font-bold text-[#ED5A27] mb-3">Copyright and Intellectual Property</h2>
                  <div className="space-y-3 text-gray-700">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-[#ED5A27] mb-3">Contact Information</h2>
                  <p className="text-gray-700">
                  ...
                  <div className="mt-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                    <div className="flex items-center gap-3">
                      <div className="flex-shrink-0">
                        <svg className="w-5 h-5 text-[#ED5A27]" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
