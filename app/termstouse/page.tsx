        ...
        <SectionContainer>
          <div className="max-w-10xl mx-auto">
              ...
              <div className="space-y-8">
                ...
                <div className="border-b pb-6">
                  <h2 className="text-2xl font-bold text-[#FF6A00] mb-3">Prohibited and Unlawful Use</h2>
                  <p className="text-gray-700">
                ...
                <div className="border-b pb-6">
                  <h2 className="text-2xl font-bold text-[#FF6A00] mb-3">Professional Advice</h2>
                  <p className="text-gray-700">
                ...
                <div className="border-b pb-6">
                  <h2 className="text-2xl font-bold text-[#FF6A00] mb-3">Governing Law and Jurisdiction</h2>
                  <p className="text-gray-700">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-[#FF6A00] mb-3">Contact Information</h2>
                  <p className="text-gray-700">
