    ...
    <div className="bg-white">
      {step === 'phone' && (
        <>
          <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top_left,#F8E7EC,transparent_28%),radial-gradient(circle_at_80%_20%,#E8F6FC,transparent_32%),linear-gradient(#ffffff,#F3F8FC)]">
            ...
            <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-4 py-16 lg:grid-cols-2 lg:py-24">
              <div>
                ...
                <h1 className="mt-5 text-4xl font-bold leading-tight text-[#171A1B] md:text-5xl">
          ...
          <section id="register" className="bg-[#171A1B] px-4 py-10 text-white">
          ...
          <section className="bg-[#F3F8FC] px-4 py-10">
            <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[280px_1fr]">
              <div className="h-fit space-y-5 rounded-2xl bg-white p-5 shadow-sm">
                <h3 className="font-semibold text-[#171A1B]">Event Details</h3>
                <div className="flex gap-3 text-sm text-slate-600">
                  <Calendar className="mt-0.5 h-5 w-5 text-[#0092D7]" />
                  <div>
                    <p className="font-medium text-[#171A1B]">Event Dates</p>
                ...
                <div className="flex gap-3 text-sm text-slate-600">
                  ...
                  <div>
                    <p className="font-medium text-[#171A1B]">Venue</p>
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm">
                ...
                <h3 className="mt-2 text-2xl font-bold text-[#171A1B]">Choose Verification Method</h3>
                ...
                <div className="mt-5 grid grid-cols-2 rounded-xl bg-slate-100 p-1">
                  {(['sms', 'whatsapp'] as Channel[]).map((item) => (
                    <button
                      ...
                      className={`rounded-lg py-2.5 text-sm font-semibold capitalize ${channel === item ? 'bg-white text-[#171A1B] shadow-sm' : 'text-slate-500'}`}
                    >
                ...
                <label className="mt-5 block text-sm font-medium text-[#171A1B]">Mobile Number *</label>
                ...
                <button
                  ...
                  onClick={sendOtp}
                  disabled={loading}
                  className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#171A1B] px-4 py-3 text-sm font-semibold text-white disabled:opacity-60"
                >
          ...
          <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[260px_1fr]">
            ...
            <form onSubmit={completeRegistration} className="rounded-2xl bg-white p-6 shadow-sm">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <h2 className="text-2xl font-bold text-[#171A1B]">Complete Registration</h2>
              ...
              <div className="mt-6">
                <h3 className="font-semibold text-[#171A1B]">What are you looking for?</h3>
              ...
              <button type="submit" disabled={loading} className="mt-6 w-full rounded-xl bg-[#171A1B] py-3 font-semibold text-white disabled:opacity-60">
      ...
      {step === 'success' && pass && (
        <section className="bg-[#F3F8FC] px-4 py-12">
          <div className="mx-auto max-w-lg text-center">
            ...
            <h2 className="text-3xl font-bold text-[#171A1B]">Registration Successful!</h2>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <a href="/" className="rounded-xl bg-[#171A1B] py-3 text-sm font-semibold text-white">Back to Home</a>
      ...
      {otpOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 p-4">
          <div className="w-full max-w-md rounded-3xl bg-white p-6 shadow-2xl">
            ...
            <h3 className="mt-4 text-2xl font-bold text-[#171A1B]">Verify Your Phone Number</h3>
...
function StatusCard({ title, body }: { title: string; body: string }) {
  return (
    <div className="rounded-2xl bg-white p-3 shadow-sm">
      <p className="font-semibold text-[#171A1B]">{title}</p>
