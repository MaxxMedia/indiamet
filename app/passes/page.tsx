    ...
    <div className="bg-white">
      {step === 'phone' && (
        <>
          ...
          <section id="register" className="bg-[#02416E] px-4 py-10 text-white">
            ...
            <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[280px_1fr]">
              <div className="h-fit space-y-5 rounded-2xl bg-white p-5 shadow-sm">
                ...
                <div className="flex gap-3 text-sm text-slate-600">
                  ...
                  <div>
                    <p className="font-medium text-[#02416E]">Event Dates</p>
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm">
                ...
                <h3 className="mt-2 text-2xl font-bold text-[#02416E]">Choose Verification Method</h3>
                ...
                <div className="mt-5 grid grid-cols-2 rounded-xl bg-slate-100 p-1">
                  {(['sms', 'whatsapp'] as Channel[]).map((item) => (
                    <button
                      ...
                      className={`rounded-lg py-2.5 text-sm font-semibold capitalize ${channel === item ? 'bg-white text-[#02416E] shadow-sm' : 'text-slate-500'}`}
                    >
                ...
                <label className="mt-5 block text-sm font-medium text-[#02416E]">Mobile Number *</label>
                ...
                <button
                  ...
                  onClick={sendOtp}
                  disabled={loading}
                  className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#02416E] px-4 py-3 text-sm font-semibold text-white disabled:opacity-60"
                >
          ...
          <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[260px_1fr]">
            ...
            <form onSubmit={completeRegistration} className="rounded-2xl bg-white p-6 shadow-sm">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <h2 className="text-2xl font-bold text-[#02416E]">Complete Registration</h2>
              ...
              <div className="mt-6">
                <h3 className="font-semibold text-[#02416E]">What are you looking for?</h3>
              ...
              <button type="submit" disabled={loading} className="mt-6 w-full rounded-xl bg-[#02416E] py-3 font-semibold text-white disabled:opacity-60">
      ...
      {step === 'success' && pass && (
        <section className="bg-[#F3F8FC] px-4 py-12">
          <div className="mx-auto max-w-lg text-center">
            ...
            <h2 className="text-3xl font-bold text-[#02416E]">Registration Successful!</h2>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <a href="/" className="rounded-xl bg-[#02416E] py-3 text-sm font-semibold text-white">Back to Home</a>
...
function StatusCard({ title, body }: { title: string; body: string }) {
  return (
    <div className="rounded-2xl bg-white p-3 shadow-sm">
      <p className="font-semibold text-[#02416E]">{title}</p>
