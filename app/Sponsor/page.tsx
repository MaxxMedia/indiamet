                        ...
                        <SectionContainer>
                            <div className="max-w-4xl text-white">
                                ...
                                >
                                    AWARD SPONSOR
                                    <br />
                                    <span className="text-[#ED5A27]">PARTNERSHIP FORM</span>
                                </motion.h1>
                ...
                <section className="py-4 bg-gray-50 border-b border-gray-100">
                    <SectionContainer>
                        <div className="flex items-center gap-2 text-sm text-black">
                            ...
                            <span className="text-black">/</span>
                            <span className="text-[#ED5A27] font-medium">Sponsor Partnership</span>
                        </div>
                    </SectionContainer>
                </section>
                    ...
                    <SectionContainer>
                        <div className="grid lg:grid-cols-2 gap-8">
                            ...
                            >
                                ...
                                <button
                                    onClick={() => router.back()}
                                    className="inline-flex items-center gap-2 text-black hover:text-[#ED5A27] transition-colors mb-6"
                                >
                                    ← BACK
                                </button>

                                <h2 className="text-[#ED5A27] font-bold text-lg mb-1">SPONSOR INFORMATION</h2>
                                ...
                                <h2 className="text-[#ED5A27] font-bold text-lg mt-8 mb-4">SPONSORSHIP INTEREST</h2>
                                <p className="text-black text-sm font-medium mb-3">
                                    Sponsorship Package Interested In <span className="text-[#ED5A27]">*</span>
                                </p>
                                ...
                                <label className="flex items-start gap-2 mt-4 text-sm text-black cursor-pointer">
                                    <input type="radio" name="package" className="mt-1 accent-[#ED5A27]" />
                                    <span>
                                ...
                                <label className="flex items-center gap-2 mt-6 text-sm text-black">
                                    <input type="checkbox" className="accent-[#ED5A27]" />
                                    <span>
                                        I agree to the <a className="text-[#ED5A27] underline">terms & conditions</a> and{" "}
                                ...
                                <button
                                    type="submit"
                                    className="mt-6 inline-flex items-center gap-2 bg-[#ED5A27] hover:bg-[#ED5A27]/90 text-white font-semibold px-6 py-3 rounded-full transition-colors"
                                >
                                    SUBMIT ENQUIRY →
                                </button>
                            </motion.div>
                            ...
                            <aside className="flex flex-col gap-6 text-black">
                                ...
                                >
                                    ...
                                    <Link href={"/awards"}>
                                        <button className="text-sm font-semibold text-[#ED5A27] border border-[#ED5A27]/50 rounded-md px-4 py-2 hover:bg-[#ED5A27]/10 transition-colors">
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="p-6 md:p-8">
                                    <span className="inline-block text-xs font-semibold tracking-widest text-[#ED5A27] border border-[#ED5A27]/40 rounded-full px-3 py-1 mb-3">
                                    ...
                                    <h4 className="text-[#ED5A27] font-bold text-sm mb-3">WHAT YOU GET</h4>
                                    <ul className="space-y-2 mb-6">
                                        {selectedPackage.benefits.map((b) => (
                                            <li key={b} className="flex items-start gap-2 text-sm text-black">
                                                <span className="text-[#ED5A27] mt-0.5">✓</span>
                                                <span>{b}</span>
                                            </li>
                                        ))}
                                    </ul>
                                    ...
                                    <button
                                        onClick={() => setIsModalOpen(false)}
                                        className="w-full inline-flex items-center justify-center gap-2 bg-[#ED5A27] hover:bg-[#ED5A27]/90 text-white font-semibold px-6 py-3 rounded-full transition-colors"
                                    >
