                    ...
                    <SectionContainer>
                        <div className="grid lg:grid-cols-2 gap-8">
                            ...
                            >
                                ...
                                <button
                                    onClick={() => router.back()}
                                    className="inline-flex items-center gap-2 text-black hover:text-[#FF6A00] transition-colors mb-6"
                                >
                                    ← BACK
                                </button>
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="p-6 md:p-8">
                                    <span className="inline-block text-xs font-semibold tracking-widest text-[#FF6A00] border border-[#FF6A00]/40 rounded-full px-3 py-1 mb-3">
                                    ...
                                    <h4 className="text-[#FF6A00] font-bold text-sm mb-3">WHAT YOU GET</h4>
                                    ...
                                    <button
                                        onClick={() => setIsModalOpen(false)}
                                        className="w-full inline-flex items-center justify-center gap-2 bg-[#FF6A00] hover:bg-[#FF6A00]/90 text-white font-semibold px-6 py-3 rounded-full transition-colors"
                                    >
