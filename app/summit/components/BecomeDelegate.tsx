  ...
  const delegatePackages = [
    {
      ...
      price: "₹ 3,500",
      features: [
      "Access to all technical Summitsessions",
       "Summitkit (Badge, Folder, Notepad, Pen)",
      ...
      "Digital access to Summitpresentation summaries",
      "Lunch & refreshments",
      ],
    ...
    },
    {
      ...
      price: "₹ 6,000",
      features: [
        "Full access to all Summitsessions",
        "Entry to exhibition area (all 3 days)",
        "Summitkit (Badge, Folder, Notepad, Pen)",
    ...
    },
    {
      ...
      price: "₹ 15,000",
      features: [
"Full Summitaccess (all sessions)",
                    ...
                    <div className="mt-auto pt-4 md:pt-5">
                      ...
                      <div className="flex flex-col sm:flex-row flex-wrap gap-2 md:gap-3">
                        <Link href={pkg.cardLink} className="flex-1 min-w-[120px]">
                          <button className="w-full rounded-full bg-[#B80A26] px-4 py-2 md:px-6 md:py-3 text-xs md:text-sm font-semibold text-white transition-all hover:bg-mainColor4">
                            Register
                          </button>
                        </Link>
