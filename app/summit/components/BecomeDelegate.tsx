                    ...
                    <div className="mt-auto pt-4 md:pt-5">
                      ...
                      <div className="flex flex-col sm:flex-row flex-wrap gap-2 md:gap-3">
                        <Link href={pkg.cardLink} className="flex-1 min-w-[120px]">
                          <button className="w-full rounded-full bg-[#1DA428] px-4 py-2 md:px-6 md:py-3 text-xs md:text-sm font-semibold text-white transition-all hover:bg-mainColor4">
                            Register
                          </button>
                        </Link>
