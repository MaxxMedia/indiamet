...
const visaPageData = {
  hero: {
    title: "Visa Support",
    description:
      "Here International exhibitors, partners, and visitors attending INDIAMET 2027 can find important information here regarding visa requirements and travel to India.",
  },
  blocks: [
    {
                    ...
                    {block.Image?.data && index === 1 ? (
                      <>
                        <img
                          ...
                          alt="INDIAMET 2027 Expo Visa Support"
