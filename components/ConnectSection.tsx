...
export default function ConnectSection() {
  return (
    <section className="relative z-1 overflow-hidden bg-[#171A1B] text-white py-32">
      <SectionContainer>
...
The connections you make at INDIAMET 2027 don't end with the exhibition. Stay engaged with industry leaders, technology providers, manufacturers, and quality professionals through our year-round updates, networking initiatives, technical programs, and future editions of INDIAMET.  </p>
            </div>
  ...
  <div className="absolute inset-0 flex items-center justify-center z-[-1]">
    <div className="absolute w-[500px] h-[500px] rounded-full bg-[#B80A26] opacity-20" />
    <div className="absolute w-[350px] h-[350px] rounded-full bg-[#B80A26] opacity-20" />
  </div>
