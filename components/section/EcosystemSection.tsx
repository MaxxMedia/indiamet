...
- Schedule meetings, manage contacts, and follow up on business leads seamlessly through a single digital platform.`,
      ...
      <div className="relative z-10">
        <SectionContainer>
          ...
          <div className="mb-14 flex max-w-8xl flex-col gap-6">
            ...
            <Link
              href="/why-exhibit"
              className="inline-block w-fit rounded-full bg-[#FE6B0B] px-10 py-4 font-semibold text-white transition hover:bg-mainColor4"
            >
              Why Exhibit
            </Link>
          </div>
  ...
  />
                ...
                <div className="mt-auto p-6 pt-4 xl:p-8">
                  <Link
                    href={item.link}
                    className="block w-full rounded-full bg-[#FE6B0B] px-8 py-4 text-center text-lg font-semibold text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-mainColor4 hover:shadow-lg"
                  >
                    {item.buttonText}
                  </Link>
                </div>
