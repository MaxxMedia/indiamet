...
<p className="text-lg text-black/70">
            ...
            <Link
              href="/why-exhibit"
              className="inline-block w-fit rounded-full bg-[#8b1a3a] px-10 py-4 font-semibold text-white transition hover:bg-mainColor4"
            >
              Why Exhibit
            </Link>
          </div>
  ...
  />
                ...
                <div className="mt-auto p-6 pt-4 xl:p-8">
                  <Link
                    href={item.link}
                    className="block w-full rounded-full bg-[#8b1a3a] px-8 py-4 text-center text-lg font-semibold text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-mainColor4 hover:shadow-lg"
                  >
                    {item.buttonText}
                  </Link>
                </div>
