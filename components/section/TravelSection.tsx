      ...
      <SectionContainer>
        <div className="relative">
          <div className="flex flex-col items-center text-center space-y-8 lg:space-y-10 py-16 lg:py-24">
            ...
            >
              <button className="inline-flex items-center justify-center bg-[#8b1a3a] text-white font-bold text-lg px-10 py-4 rounded-full transition-all duration-300 hover:shadow-2xl transform hover:-translate-y-1 active:translate-y-0 shadow-lg">
                Plan Your Travel
                <svg 
