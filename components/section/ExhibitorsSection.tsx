    ...
    />
      ...
      <div className="flex justify-center">
        <Link href="/exhibition-directory" target="_blank" rel="noopener noreferrer">
          <button className="group flex items-center gap-3 rounded-full px-10 py-4 text-[18px] font-semibold bg-[#ffcb9a] text-white transition hover:bg-mainColor4 hover:shadow-xl">
