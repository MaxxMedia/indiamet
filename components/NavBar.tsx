    ...
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-[999] font-parabolica">
        ...
        <div className="xl:hidden">
          <div className="mx-auto max-w-[1800px]">
            <div
              ...
              className="w-full"
            >
              <div className="bg-[#333839d] text-white w-full">
                ...
                <div className="flex items-center gap-1.5 xs:gap-2 sm:gap-3 md:gap-4 px-3 xs:px-4 sm:px-6 md:px-8 py-5 xs:py-6 sm:py-8 md:py-10 min-h-[100px] xs:min-h-[120px] sm:min-h-[140px] md:min-h-[160px]">
                  ...
                  <div className="flex items-center gap-1.5 xs:gap-2 sm:gap-3 md:gap-4 flex-shrink-0">
                    ...
                    <Link
                      ...
                      aria-label="Login"
                      title="Login"
                      className="flex items-center justify-center text-white hover:text-[#b80a26] active:scale-90 transition-all flex-shrink-0"
                    >
        ...
        <div className={`hidden xl:block px-2 sm:px-4 md:px-6 lg:px-8 transition-all duration-300 ${scrolled ? "pt-1.5 sm:pt-2" : "pt-2 sm:pt-3 md:pt-4"}`}>
          <div className="mx-auto max-w-[1800px]">
            <div className="rounded-xl sm:rounded-2xl lg:rounded-3xl bg-[#333839d] text-white shadow-xl">
            ...
            {!scrolled && (
              <div className="flex justify-end w-full pr-4">
                <div className="flex items-center gap-2">
                  <div className="flex items-center gap-4 rounded-b-xl bg-[#333839d] px-4 py-1 text-[clamp(11px,0.7vw,14px)] text-white shadow-md">
                  ...
                  <Link href="/login">
                    <div className="flex items-center rounded-b-xl bg-[#333839d] px-3 py-1 text-[clamp(11px,0.7vw,14px)] text-white font-bold cursor-pointer hover:bg-[#b80a26] active:scale-95 transition-all shadow-md">
                      EXHIBITOR LOGIN
                    </div>
                  </Link>
                </div>
