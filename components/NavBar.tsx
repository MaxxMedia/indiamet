    ...
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-[999] font-parabolica">
        ...
        <div className="xl:hidden">
          <div className="mx-auto max-w-[1800px]">
            <div
              ...
              className="w-full"
            >
              <div className="bg-[#171A1B] text-white w-full">
                ...
                <div className="flex items-center gap-1.5 xs:gap-2 sm:gap-3 md:gap-4 px-3 xs:px-4 sm:px-6 md:px-8 py-5 xs:py-6 sm:py-8 md:py-10 min-h-[100px] xs:min-h-[120px] sm:min-h-[140px] md:min-h-[160px]">
                  ...
                  <div className="flex items-center gap-1.5 xs:gap-2 sm:gap-3 md:gap-4 flex-shrink-0">
                    ...
                    <Link
                      ...
                      aria-label="Login"
                      title="Login"
                      className="flex items-center justify-center text-white hover:text-[#C8102E] active:scale-90 transition-all flex-shrink-0"
                    >
        ...
        <div className={`hidden xl:block px-2 sm:px-4 md:px-6 lg:px-8 transition-all duration-300 ${scrolled ? "pt-1.5 sm:pt-2" : "pt-2 sm:pt-3 md:pt-4"}`}>
          <div className="mx-auto max-w-[1800px]">
            <div className="rounded-xl sm:rounded-2xl lg:rounded-3xl bg-[#171A1B] text-white shadow-xl">
              <div className="flex items-center justify-between gap-2 xl:gap-5 2xl:gap-6 px-3 xl:px-6 2xl:px-8 py-3 xl:py-4 2xl:py-5 min-h-[104px] xl:min-h-[120px] 2xl:min-h-[128px]">
                      ...
                      >
                        <button className="flex items-center gap-0.5 lg:gap-0.5 xl:gap-1 hover:text-gray-200 relative whitespace-nowrap transition-colors px-0.5 lg:px-1">
                          <span className={`relative font-medium text-[clamp(14px,0.9vw,17px)]`}>
                            ...
                            <span className="absolute -bottom-1 left-0 w-0 h-[1.5px] lg:h-[2px] bg-[#C8102E] group-hover:w-full transition-all duration-300"></span>
                          </span>
                ...
                <div className="hidden xl:flex items-center gap-[clamp(3px,0.4vw,12px)] flex-shrink-0">
                  <Button
                    ...
                    className="bg-[#C8102E] hover:bg-[#C8102E] px-[clamp(6px,0.6vw,16px)] py-[clamp(4px,0.5vw,10px)] whitespace-nowrap transition-all text-[clamp(7px,0.55vw,13px)] font-bold rounded-full"
                  >
            ...
            {!scrolled && (
              <div className="flex justify-end w-full pr-4">
                <div className="flex items-center gap-2">
                  <div className="flex items-center gap-4 rounded-b-xl bg-[#171A1B] px-4 py-1 text-[clamp(11px,0.7vw,14px)] text-white shadow-md">
                  ...
                  <Link href="/login">
                    <div className="flex items-center rounded-b-xl bg-[#171A1B] px-3 py-1 text-[clamp(11px,0.7vw,14px)] text-white font-bold cursor-pointer hover:bg-[#C8102E] active:scale-95 transition-all shadow-md">
                      EXHIBITOR LOGIN
                    </div>
                  </Link>
                </div>
            ...
            <div className="px-4 sm:px-6 md:px-8 py-4">
              ...
              <div className="mt-6 space-y-3 sm:flex sm:space-y-0 sm:gap-3">
                <Button
                  href="/exhibiting-enquiry"
                  onClick={() => setMobileMenuOpen(false)}
                  className="bg-[#C8102E] text-white text-sm sm:text-base py-3 font-semibold rounded-md w-full"
                >
                  EXHIBITOR REGISTRATION
                </Button>
                <Button
