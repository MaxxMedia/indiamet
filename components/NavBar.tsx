    ...
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-[999] font-parabolica">
        ...
        <div className="xl:hidden">
          <div className="mx-auto max-w-[1800px]">
            <div
              ...
              className="w-full"
            >
              <div className="bg-[#25272E] text-white w-full">
        ...
        <div className={`hidden xl:block px-2 sm:px-4 md:px-6 lg:px-8 transition-all duration-300 ${scrolled ? "pt-1.5 sm:pt-2" : "pt-2 sm:pt-3 md:pt-4"}`}>
          <div className="mx-auto max-w-[1800px]">
            <div className="rounded-xl sm:rounded-2xl lg:rounded-3xl bg-[#25272E] text-white shadow-xl">
            ...
            {!scrolled && (
              <div className="flex justify-end w-full pr-4">
                <div className="flex items-center gap-2">
                  <div className="flex items-center gap-4 rounded-b-xl bg-[#25272E] px-4 py-1 text-[clamp(11px,0.7vw,14px)] text-white shadow-md">
                  ...
                  <Link href="/login">
                    <div className="flex items-center rounded-b-xl bg-[#25272E] px-3 py-1 text-[clamp(11px,0.7vw,14px)] text-white font-bold cursor-pointer hover:bg-[#ED5A27] active:scale-95 transition-all shadow-md">
                      EXHIBITOR LOGIN
                    </div>
                  </Link>
                </div>
