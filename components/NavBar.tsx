        ...
        <div className={`px-2 sm:px-4 md:px-6 lg:px-8 transition-all duration-300 ${scrolled ? "pt-1.5 sm:pt-2" : "pt-2 sm:pt-3 md:pt-4"}`}>
          <div className="mx-auto max-w-[1600px]">
            ...
            <div className="lg:hidden w-full absolute top-0 left-0 right-0 z-50">
              <div className="bg-gradient-to-r from-[#002A34] to-[#002A34] text-white w-full">
...
<Link href="/login" className="relative z-[1001]">
  <div className="flex items-end gap-1.5 rounded-b-xl bg-[#102a55] px-2 py-0.5 text-[12px] text-white cursor-pointer hover:bg-[#0d1e3c] active:scale-95 transition-all">
    <span className="font-bold">Exhibitor Login</span>
            ...
            <div className="hidden lg:block rounded-xl sm:rounded-2xl lg:rounded-3xl bg-gradient-to-r from-[#002A34] to-[#002A34] text-white shadow-xl">
