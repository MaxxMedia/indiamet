...
export default function DiscoverSection() {
  return (
    <section className="bg-[#25272E] py-32 text-white">
      <SectionContainer>
        <div className="grid lg:grid-cols-12 gap-16">
          <div className="lg:col-span-7 lg:border-l lg:border-white/20 lg:pl-14">
            <h2 className="text-5xl lg:text-6xl xl:text-7xl font-bold leading-[0.85] tracking-tight">
              Discover <span className="text-[#ED5A27]">INDIAMET</span>
            </h2>
            ...
            <a href="/post-show-report" className="inline-block mt-10">
              <button className="rounded-full bg-white text-[#ED5A27] px-8 lg:px-10 py-3 lg:py-4 font-semibold hover:bg-[#ED5A27] hover:text-white transition-colors">
                Download Brochure
              </button>
            </a>
          </div>
