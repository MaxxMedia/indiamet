      ...
      <SectionContainer>
        ...
        <div className="mb-16 flex flex-col items-center text-center">
          ...
          >
            ...
            <span className="text-sm font-medium text-[#002A34]">
              Partners & Sponsors
            </span>
          </div>
                ...
                >
                  <div className="h-48 rounded-2xl border border-blue-100 bg-gradient-to-br from-white to-blue-50 p-8 shadow-lg transition hover:shadow-xl">
                    <div className="flex h-full flex-col items-center justify-center gap-6">
                      <div className="flex h-20 w-20 items-center justify-center rounded-xl bg-white shadow-inner text-2xl font-bold text-[#002A34]">
                        {partner.name
                          .split(' ')
                          .map(w => w[0])
                          .join('')
          ...
          {partners.slice(0, 6).map((partner, index) => (
            ...
            >
              <div className="flex h-full flex-col items-center justify-center gap-4">
                <div className="flex h-14 w-14 items-center justify-center rounded-lg bg-white shadow-inner text-lg font-bold text-[#002A34]">
                  {partner.name
                    .split(' ')
                    .map(w => w[0])
                    .join('')
