        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between mb-16">
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="flex h-12 w-12 items-center justify-center rounded-full bg-[#9BB6D9] text-white disabled:opacity-40 hover:bg-[#071D49] transition-colors"
            >
              ←
            </button>
            <button
              ...
              className="flex h-12 w-12 items-center justify-center rounded-full bg-[#071D49] text-white disabled:opacity-40 hover:bg-[#00264d] transition-colors"
            >
              →
            </button>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {impacts
            ...
            .map((impact, i) => (
              <div
                key={i}
                className="flex flex-col overflow-hidden rounded-2xl bg-[#071D49] text-white"
              >
                ...
                <div className="bg-[#071D49] p-6 lg:p-8">
