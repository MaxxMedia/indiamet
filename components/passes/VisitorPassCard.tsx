...
export default function VisitorPassCard({
  ...
  return (
    <div className={`mx-auto overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl ${compact ? 'w-full max-w-sm' : 'w-full max-w-md'}`}>
      <div className="bg-gradient-to-r from-[#0092D7] to-[#00857C] px-6 py-3 text-center">
        <p className="text-xs font-bold tracking-[0.25em] text-white">VISITOR PASS</p>
      </div>
      <div className="px-6 py-6 text-center">
        <div className="mx-auto mb-3 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-[#00857C] to-[#0092D7] text-2xl font-bold text-white">
          {initial}
        </div>
        <h3 className="text-xl font-bold text-[#191C1C]">{pass.name || 'Visitor'}</h3>
