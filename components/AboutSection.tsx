    ...
    <section ref={sectionRef} className="relative overflow-hidden py-32">
      ...
      <SectionContainer>
        <div className="flex flex-col gap-6">
          ...
          {/* BUTTON — BELOW TEXT */}
          <a href="/about-INDIAMET" className="mt-4 w-fit">
            <button
              ref={buttonRef}
              className="group flex items-center gap-2 rounded-full bg-[#FF6A00] px-10 py-4 text-[16px] font-semibold text-white transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-[#33A8DF]/30 opacity-0"
            >
              Learn More
              <svg
            ...
            {stats.map((stat, index) => (
              ...
              >
                <div className="border-b border-black/10 pb-5 text-center">
                  <h3 className="mb-2 text-5xl md:text-6xl font-parabolica font-bold leading-none text-[#FF6A00]">
                    {stat.value}
                  </h3>
