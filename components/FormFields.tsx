...
/* =========================================================
   ...
   FIX: switched every one of these to the gray/white/#F37021
    ...
    return (
        <div className="relative">
            ...
            <input
                ...
                className={`w-full ${prefix ? 'pl-12' : 'px-3'} py-2.5 text-sm bg-white border border-gray-300 rounded-md text-gray-900 placeholder:text-gray-400 focus:border-[#F37021] focus:ring-1 focus:ring-[#F37021] outline-none transition`}
            />
        </div>
    );
}
...
export function TextArea({
    ...
    return (
        <textarea
            ...
            rows={rows}
            defaultValue={value === undefined ? defaultValue : undefined}
            className="w-full px-3 py-2.5 text-sm bg-white border border-gray-300 rounded-md text-gray-900 placeholder:text-gray-400 focus:border-[#F37021] focus:ring-1 focus:ring-[#F37021] outline-none transition resize-vertical"
        />
    );
}
...
export function Select({
    ...
    return (
        <select
            ...
            required={required}
            defaultValue={value === undefined ? (defaultValue ?? '') : undefined}
            className="w-full px-3 py-2.5 text-sm bg-white border border-gray-300 rounded-md text-gray-900 focus:border-[#F37021] focus:ring-1 focus:ring-[#F37021] outline-none transition appearance-none"
        >
...
export function RadioCard({ title, price, note, name, defaultChecked = false }: RadioCardProps) {
    return (
        <label className="relative flex flex-col items-center justify-center p-3 border border-gray-300 rounded-lg cursor-pointer hover:border-[#F37021] has-[:checked]:border-[#F37021] has-[:checked]:ring-1 has-[:checked]:ring-[#F37021] has-[:checked]:bg-[#F37021]/5 transition-colors bg-white text-center min-h-[100px]">
            <input
                type="radio"
                name={name}
                defaultChecked={defaultChecked}
                className="absolute top-2 right-2 accent-[#F37021]"
            />
            <span className="text-xs font-bold text-[#F37021] tracking-wider">{title}</span>
    ...
    return (
        <button
            ...
            className={`w-full flex items-center justify-center gap-2 py-3.5 px-6 rounded-lg font-semibold text-white transition-all text-sm ${loading
                ...
                : 'bg-[#F37021] hover:bg-[#152d57] active:scale-[0.98]'
                }`}
        >
            {loading ? (
                <>
