...
/* =========================================================
   ...
   FIX: switched every one of these to the gray/white/#C8102E
    ...
    return (
        <div className="relative">
            ...
            <input
                ...
                className={`w-full ${prefix ? 'pl-12' : 'px-3'} py-2.5 text-sm bg-white border border-gray-300 rounded-md text-gray-900 placeholder:text-gray-400 focus:border-[#C8102E] focus:ring-1 focus:ring-[#C8102E] outline-none transition`}
            />
        </div>
    );
}
...
export function TextArea({
    ...
    return (
        <textarea
            ...
            rows={rows}
            defaultValue={value === undefined ? defaultValue : undefined}
            className="w-full px-3 py-2.5 text-sm bg-white border border-gray-300 rounded-md text-gray-900 placeholder:text-gray-400 focus:border-[#C8102E] focus:ring-1 focus:ring-[#C8102E] outline-none transition resize-vertical"
        />
    );
}
...
export function Select({
    ...
    return (
        <select
            ...
            required={required}
            defaultValue={value === undefined ? (defaultValue ?? '') : undefined}
            className="w-full px-3 py-2.5 text-sm bg-white border border-gray-300 rounded-md text-gray-900 focus:border-[#C8102E] focus:ring-1 focus:ring-[#C8102E] outline-none transition appearance-none"
        >
...
export function RadioCard({ title, price, note, name, defaultChecked = false }: RadioCardProps) {
    return (
        <label className="relative flex flex-col items-center justify-center p-3 border border-gray-300 rounded-lg cursor-pointer hover:border-[#C8102E] has-[:checked]:border-[#C8102E] has-[:checked]:ring-1 has-[:checked]:ring-[#C8102E] has-[:checked]:bg-[#C8102E]/5 transition-colors bg-white text-center min-h-[100px]">
            <input
                type="radio"
                name={name}
                defaultChecked={defaultChecked}
                className="absolute top-2 right-2 accent-[#C8102E]"
            />
            <span className="text-xs font-bold text-[#C8102E] tracking-wider">{title}</span>
