...
/* =========================================================
   ...
   FIX: switched every one of these to the gray/white/#ED5A27
    ...
    return (
        <div className={`flex flex-col gap-1.5 ${className}`}>
            <label className="text-xs font-medium text-gray-700 tracking-wide">
                {label} {required && <span className="text-[#ED5A27]">*</span>}
            </label>
            {children}
        </div>
    );
    ...
    return (
        <div className="relative">
            ...
            <input
                ...
                className={`w-full ${prefix ? 'pl-12' : 'px-3'} py-2.5 text-sm bg-white border border-gray-300 rounded-md text-gray-900 placeholder:text-gray-400 focus:border-[#ED5A27] focus:ring-1 focus:ring-[#ED5A27] outline-none transition`}
            />
        </div>
    );
}
...
export function TextArea({
    ...
    return (
        <textarea
            ...
            rows={rows}
            defaultValue={value === undefined ? defaultValue : undefined}
            className="w-full px-3 py-2.5 text-sm bg-white border border-gray-300 rounded-md text-gray-900 placeholder:text-gray-400 focus:border-[#ED5A27] focus:ring-1 focus:ring-[#ED5A27] outline-none transition resize-vertical"
        />
    );
}
...
export function Select({
    ...
    return (
        <select
            ...
            required={required}
            defaultValue={value === undefined ? (defaultValue ?? '') : undefined}
            className="w-full px-3 py-2.5 text-sm bg-white border border-gray-300 rounded-md text-gray-900 focus:border-[#ED5A27] focus:ring-1 focus:ring-[#ED5A27] outline-none transition appearance-none"
        >
...
export function RadioCard({ title, price, note, name, defaultChecked = false }: RadioCardProps) {
    return (
        <label className="relative flex flex-col items-center justify-center p-3 border border-gray-300 rounded-lg cursor-pointer hover:border-[#ED5A27] has-[:checked]:border-[#ED5A27] has-[:checked]:ring-1 has-[:checked]:ring-[#ED5A27] has-[:checked]:bg-[#ED5A27]/5 transition-colors bg-white text-center min-h-[100px]">
            <input
                type="radio"
                name={name}
                defaultChecked={defaultChecked}
                className="absolute top-2 right-2 accent-[#ED5A27]"
            />
            <span className="text-xs font-bold text-[#ED5A27] tracking-wider">{title}</span>
