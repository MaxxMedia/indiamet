...
export default function NewsletterSection() {
  return (
    <section className="py-16 sm:py-20 lg:py-24 xl:py-32">
      <SectionContainer>
        {/* CARD */}
        <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl lg:rounded-[36px] bg-gradient-to-r from-[#171A1B] to-[] px-4 sm:px-6 lg:px-8 xl:px-10 2xl:px-14 py-8 sm:py-10 lg:py-12 xl:py-14 text-white">
          ...
          <div className="relative z-10 max-w-[1050px] space-y-4 sm:space-y-5 lg:space-y-6">
            ...
            <a href="/newsletter" className="inline-block pt-3 sm:pt-4">
              <button className="rounded-full bg-white px-6 sm:px-8 py-2.5 sm:py-3 text-sm sm:text-[15px] font-semibold text-[#171A1B] transition hover:bg-[#B80A26] hover:text-white">
                Sign up Today
              </button>
            </a>
          </div>
          ...
          {/* BACKGROUND CIRCLES */}
          <div className="pointer-events-none absolute -bottom-[35%] -right-[8%] z-0 h-[300px] w-[300px] sm:h-[400px] sm:w-[400px] lg:h-[520px] lg:w-[520px] rounded-full bg-[#B80A26]/25" />
          <div className="pointer-events-none absolute -bottom-[20%] -right-[3%] z-0 h-[200px] w-[200px] sm:h-[260px] sm:w-[260px] lg:h-[360px] lg:w-[360px] rounded-full bg-[#B80A26]/25" />
        </div>
      </SectionContainer>
    </section>
  );
