...
export default function NewsletterSection() {
  return (
    <section className="py-16 sm:py-20 lg:py-24 xl:py-32">
      <SectionContainer>
        {/* CARD */}
        <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl lg:rounded-[36px] bg-gradient-to-r from-[#2c3531] to-[] px-4 sm:px-6 lg:px-8 xl:px-10 2xl:px-14 py-8 sm:py-10 lg:py-12 xl:py-14 text-white">
          ...
          <div className="relative z-10 max-w-[1050px] space-y-4 sm:space-y-5 lg:space-y-6">
            ...
            <a href="/newsletter" className="inline-block pt-3 sm:pt-4">
              <button className="rounded-full bg-white px-6 sm:px-8 py-2.5 sm:py-3 text-sm sm:text-[15px] font-semibold text-[#2c3531] transition hover:bg-[#116466] hover:text-white">
                Sign up Today
              </button>
            </a>
          </div>
